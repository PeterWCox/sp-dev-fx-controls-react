...
define([], () => {
  return {
    ...
    WebPartTitlePlaceholder: "XXXXXX part title",
    ...
    TaxonomyPickerTermsNotFound:
      "The next selected term(s) could not be found in the term store: {0}",
    ...
    ListItemAttachmentserrorLoadAttachments:
      "Error on load list item attachment, reason: {0}",
    ListItemAttachmentsconfirmDelete:
      "Are you sure you want send the attachment {0} to the site recycle bin?",
    ...
    ListItemAttachmentsuploadAttachmentErrorMsg:
      "The file {0} not attached, reason: {1}",
    ...
    FontColorLabel: "Font Colour",
    AutomaticFontColor: "Automatic",
    HighlightColorLabel: "Highlight colour",
    NoColorHighlightColor: "No colour",
    IncreaseIndentTitle: "Increase indent",
    DecreaseIndentTitle: "Decrease indent",
    ThemeColorsGroupName: "Theme colours",
    HighlightColorsGroupName: "Highlight colours",
    StandardColorsGroupName: "Standard colours",
    CustomColorsGroupName: "Custom colours",
    ...
    CantValidateValidationMessage:
      "We couldn't verify this link. Please check the link and try again.",
    ...
    CopyrightUrl:
      "https://www.microsoft.com/en-GB/legal/copyright/default.aspx",
    CopyrightWarning:
      "You are responsible for respecting others' rights, including copyright.",
    CreativeCommonsMessage:
      "These results are tagged with Creative Commons licences. Review the licences to ensure you comply.",
    DateFormat: "DD/MM/YYYY hh:mm A",
    DocumentLabelTemplate:
      "{0}, Document, Modified {1}, edited by {2}, Private",
    ...
    FolderLabelTemplate:
      "{0}, Folder, Modified {1}, edited by {2}, {3} items, Private",
    ...
    LinkFileInstructions:
      "Paste a link to a file in OneDrive for Business or SharePoint Online",
    LinkHeader: "From a link",
    LinkImageInstructions:
      "Paste a link to an image in OneDrive for Business or SharePoint Online",
    ...
    NoExternalLinksValidationMessage:
      "We only support linking to files in your own organization.",
    NoImageValidationMessage:
      "This isn't a link to a file type we support. You can only link to an image.",
    NoRecentFiles: "No recent files",
    NoRecentFilesDescription:
      "Try selecting a file from your site, or upload one from your device.",
    NoResultsBadEnglish:
    ...
    SorryWebSearch:
      "Sorry, this function isn't implemented in this sample, because it would require a Bing API key.",
    ...
    CollectionDataEmptyFields:
      "No fields were provided for the collection data.",
    ...
    MyTeamsMessageError:
      "Something went wrong while loading your teams, please try later or refresh browser",
