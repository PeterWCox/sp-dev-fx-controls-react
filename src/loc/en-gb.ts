...
define([], () => {
  return {
    ...
    CopyrightUrl: "https://www.microsoft.com/en-GB/legal/copyright/default.aspx",
    CopyrightWarning: "You are responsible for respecting others' rights, including copyright.",
    CreativeCommonsMessage: "These results are tagged with Creative Commons licences. Review the licences to ensure you comply.",
